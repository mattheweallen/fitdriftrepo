...
package com.fitdrift.util.file.gpx.extensions;

import org.w3c.dom.Document;
import org.w3c.dom.Node;

import com.fitdrift.util.file.gpx.beans.GPX;
import com.fitdrift.util.file.gpx.beans.Route;
 ...
 * <p>Any custom parser must be added to {@link com.fitdrift.util.file.gpx.GPXParser} as an extension parser 
 * before parsing a gpx file, or writing a {@link GPX} to a file. This is done by
 * calling addExtensionParser() method of {@link com.fitdrift.util.file.gpx.GPXParser}
 * <p>{@link com.fitdrift.util.file.gpx.GPXParser} parseGPX method calls several methods from the registered 
 ...
 * <br>
 * 
 * <p>{@link com.fitdrift.util.file.gpx.GPXParser} writeGPX method also calls several methods from the registered 
